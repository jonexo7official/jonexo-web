      ...
      >
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          >
            ...
            <button style={{ marginLeft: "10px" }}>👀 Ver Desafíos</button>
            <button style={{ marginLeft: "10px" }}>✏ Editar Desafío</button>
            <button style={{ marginLeft: "10px" }}>❌ Eliminar Desafío</button>
          </div>
